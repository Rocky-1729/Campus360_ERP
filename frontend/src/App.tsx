  ...
  return (
    <QueryClientProvider client={queryClient}>
          ...
          <Route element={<ProtectedRoute />}>
            ...
            <Route element={<RoleRoute allowedRoles={['admin']} />}>
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/admin/students/search" element={<AdminStudentSearch />} />
            ...
            <Route element={<RoleRoute allowedRoles={['faculty', 'admin']} />}>
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/faculty/students" element={<FacultyStudentSearch />} />
                <Route path="/faculty/students/:hallTicket" element={<FacultyStudentProfile />} />
                <Route path="/faculty/attendance" element={<AttendanceMarking />} />
                <Route path="/faculty/certificates" element={<CertificateReview />} />
                <Route path="/faculty/achievements" element={<AchievementReview />} />
            ...
            <Route element={<RoleRoute allowedRoles={['student']} />}>
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/student/achievements" element={<AchievementUpload />} />
      ...
      <Toaster
        position="top-right"
        toastOptions={{
          className: 'dark:bg-slate-900 dark:text-slate-100 dark:border dark:border-slate-800 text-xs font-semibold rounded-xl',
          duration: 3000,
        }}
      />
    </QueryClientProvider>
